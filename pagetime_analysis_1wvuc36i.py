...
session_id = '1wvuc36i' # change this to the session id you want to analyze
...
len(participant_code) # 22 total participants
...
waiting_label = ['5fd955152dc9172302e1d605',
                 '670c06bb7926d2525a7a7755',
                 '60ccbffae161aadb1880ad6c',
                 '663e3cee91031227e894384a',
                 '6786c7d17bc067f2f666cbed', # NOCODE
                 '59e7477e3e4b5a00016aa4d2',
                 '5f0a686635f72917e94c7a63', # NOCODE
                 '5e0a4154deea2b2c63fb1062',
                 '5b735a4c3503c60001a891b7']
                 

base_pay_label = ['66661b1242b581f199e49f4c',
                  '66e8c6e99be9621d5b1ed1fa',
                  '645139701683d09535202a62',
                  '5b09f4f1d282ff00015b536d',
                  '67ccc62a623f466a4ad19371']
...
len(prolific_data['participant.label'].unique().tolist()) # 10 participants
...
# Merge the two page times
all_page_time = pd.concat([waitpart_page_time, basepay_page_time], ignore_index=True)
...
len(participants) # 14 participants
...
plt.yticks(range(len(participants)), participants)
plt.ylabel('Participant Code')
plt.title('Participant Page Transitions Over Time ' + session_id)
# Create a legend for page_name colors
handles = [plt.Line2D([0], [0], marker='o', color='w', label=name, markerfacecolor=page_name_to_color[name], markersize=10) for name in relevant_page_names]
# add label for line colors
line_labels = ['Scenario Answer: -1 Against', 'Scenario Answer: 1 For']
