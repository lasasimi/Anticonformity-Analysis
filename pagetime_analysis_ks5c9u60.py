...
session_id = 'ks5c9u60' # change this to the session id you want to analyze
...
waiting_label = ['610064cd25c1c2ed6fa9b925',
                 '559c3ae1fdf99b32b55f2d33',
                 '5e06ecd524f9390991997bb7',
                 '66f2b62e0ed36bbf5a254874',
                 '5d23460ad4c57900192b129c',
                 '6134d8a566bc3dffe880e879',
                 '5d982c7ef65bb80019cc6731',
                 '5c1655c7ad682500017070d2']
                 

base_pay_label = ['67722f8e3a4f08a288a1f640',
'62c4dbae8fb1ff9cd93a3150',
'6630fcae418bde6a9e7c3b47',
'5eed1bae9e63ac127ac15a77',
'662190146ef67bab626e48cb',
'652ac43ba639f4cb5c29441e',
'63d84be2c9a21026d442e728',
'63d6873b65a6170d64a652f6',
'5ede856b1b8bce0fa7248a0f',
'663ea705b761e95caebf67eb',
'5e9f3f09ccc75a0c345e4845',
'65ae75ddcc163b8e8b23d45b',
'6785438ea7bda2a64a129770',]


full_pay_label = ['672658dbfc7d27cee21d040c',
                  '583b397f54686200010f1d20',
                  '5f4ee7ff2c5da213f015a27e',
                  '67801b3cf301ca9b3b755009',
                  '5ca51f05a15cb1001609491f',
                  '67e8aa454848956e5e32c19d',
...
len(prolific_data['participant.label'].unique().tolist()) # 37 participants
...
plt.show()
plt.savefig('average_time_differences_all_pages_' + session_id + '.png')
plt.close()
...
plt.tight_layout()
plt.savefig('participant_page_transitions_over_time_' + session_id + '.png')
plt.show()
...
# Merge the three page times
all_page_time = pd.concat([full_pay_page_time, waitpart_page_time, basepay_page_time], ignore_index=True)
...
plt.legend(handles=handles, title='Page Name', bbox_to_anchor=(1.05, 1), loc='upper left')
plt.tight_layout()
plt.savefig('participant_page_transitions_over_time_all_sorted' + session_id + '.png')
plt.show()
...
plt.legend(handles=handles, title='Page Name', bbox_to_anchor=(1.05, 1), loc='upper left')
plt.tight_layout()
plt.savefig('participant_page_transitions_over_time_all_' + session_id + '.png')
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('scenario_answers_distribution_stacked_' + session_id + '.png')
plt.show()
